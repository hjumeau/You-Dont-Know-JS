...
> Program State : la capacité à stocker et recupérer des valeurs dans des variables.  
...
> Scope : les règles qui définissent comment et où stocker et récuperer des variables.
...
> Javascript est un language compiler car le moteur javascript effectue plusieurs opérations semblable à d'autres langague compiler.

In traditional compiled-language process, a chunk of source code, your program, will undergo typically three steps *before* it is executed, roughly called "compilation":

> Trois étapes de la compilation:

1. **Tokenizing/Lexing:** breaking up a string of characters into meaningful (to the language) chunks, called tokens. For instance, consider the program: `var a = 2;`. This program would likely be broken up into the following tokens: `var`, `a`, `=`, `2`, and `;`. Whitespace may or may not be persisted as a token, depending on whether it's meaningful or not.

   > Découpe une chaine de charactères en plusieurs parties appelé 'tokens'.
