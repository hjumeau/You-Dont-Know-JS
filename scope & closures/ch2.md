...
> Cette technique permet d'accéder à une variable globale qui serait autrement inaccessible si elle est "shadowé".
Les variables non globale ne sont plus accessible quand elles sont "shadowé".
